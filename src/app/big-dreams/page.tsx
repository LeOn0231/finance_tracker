      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xs sm:text-sm text-slate-400">
              High-value milestone quests: Vehicles, Battlestations, Cameras, Watches & Grand Goals.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-12 gap-3">
            ...
            <div className="sm:col-span-2">
              ...
              >
                ...
                <option value="oldest">Oldest Quests</option>
        ...
        {isLoading ? (
          <div className="py-20 text-center">
            ...
            <p className="text-xs text-slate-400 font-mono">Consulting the Grimoire...</p>
          </div>
        ) : dreams.length === 0 ? (
          <EmptyState
            type={searchQuery || priorityFilter !== 'ALL' ? 'FILTER' : 'BIG_DREAM'}
            onAction={() => {
